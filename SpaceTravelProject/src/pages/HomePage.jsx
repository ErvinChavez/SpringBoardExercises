...
export default function HomePage() {
    ...
    return ( //return what will be viewed in this HomePage
        <span className="home">
            ...
            <div className="engineerExplorerLeader">
                <h3>🔧 Engineer, Explorer, Leader</h3>
                <div>
