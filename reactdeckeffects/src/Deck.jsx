...
function Deck() { //the deck component
  const [deck, setDeck] = useState(null); //useState for the deck being used currently
  const [drawn, setDrawn] = useState([]); //useState for the cards that have been drawn
  const [isShuffling, setIsShuffling] = useState(false); //useState to see if deck is shuffled, start as false
