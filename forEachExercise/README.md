...
This exercise focuses on using the JavaScript **`forEach`** method to iterate over arrays of objects and perform an action for each element.

---

## Overview

You are provided with an array of movie objects. Each object contains:

- `title` — the name of the movie
- `director` — the director(s) of the movie
- `yearReleased` — the year the movie was released

The goal is to iterate through this array and log a formatted message for each movie.
